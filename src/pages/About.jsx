        ...
        <div style={{marginTop:12, display:'grid', gap:8}}>
          <div style={{display:'flex', gap:12, alignItems:'center'}}>
            ...
            <div style={{color:'var(--muted)'}}>Misi 
                  <tr>
                      <ul>Mengembangkan kemampuan dan keterampilan catur mahasiswa melalui pelatihan rutin, pembinaan terarah, dan kegiatan kompetitif.
                      <ul> <ul>Menciptakan lingkungan yang kondusif untuk belajar, berlatih, dan bertukar pengetahuan antarpemain catur.
                      <ul> <ul>Menumbuhkan sportivitas, disiplin, dan rasa kebersamaan dalam setiap aktivitas klub.
                      <ul> <ul>Mengikuti serta menyelenggarakan berbagai turnamen catur sebagai ajang peningkatan prestasi dan pengalaman.
                      <ul> <ul>Menjadi duta yang membawa nama baik Universitas Satya Terra Bhinneka melalui prestasi di bidang catur.<ul>
                  </tr>
            </div>
          </div>
          <div style={{display:'flex', gap:12, alignItems:'center'}}>
